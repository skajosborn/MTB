...
export default function CarterRoadTrailPage() {
  ...
  return (
    <main className="min-h-screen">
      {/* Hero Header Section */}
      <div className="bg-gray-100 min-h-[40vh] flex flex-col items-center justify-center text-center py-16 px-4">
        <h1 className="text-5xl md:text-6xl font-bold text-gray-800 mb-4">Carter Road Trails</h1>
      ...
      <div className="bg-gradient-to-r from-blue-600 to-blue-700 py-16">
        <div className="max-w-4xl mx-auto text-center px-4">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link href="/trails" className="inline-block bg-white text-blue-600 hover:bg-gray-100 font-bold py-3 px-8 rounded-full transition-colors">
              Explore More Trails
            </Link>
            <a href="https://www.floridatrail.org/" target="_blank" rel="noopener noreferrer" className="inline-block bg-transparent text-white border-2 border-white hover:bg-white hover:text-blue-600 font-bold py-3 px-8 rounded-full transition-colors">
